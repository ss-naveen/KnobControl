...
Pod::Spec.new do |s|
  ...
  s.author             = { "Naveen" => "naveen.singisetty@xinthe.com" }
  # Or just: s.author    = "Naveen"
  # s.authors            = { "Naveen" => "naveen.singisetty@xinthe.com" }
  # s.social_media_url   = "http://twitter.com/Naveen"
  ...
  s.source       = { :git => "https://github.com/ss-naveen/KnobControl.git", :tag => "1.0.0" }
  #   s.source       = { :path => '.' }
